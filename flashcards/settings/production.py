...
from flashcards.settings.base import *  # pylint: disable=wildcard-import
from flashcards.settings.utils import get_env_setting
...
# This may be overridden by the YAML in flashcards_CFG,
# but it should be here as a default.
MEDIA_STORAGE_BACKEND = {}
FILE_STORAGE_BACKEND = {}

if 'FLASHCARDS_CFG' in environ:
    CONFIG_FILE = get_env_setting('FLASHCARDS_CFG')
