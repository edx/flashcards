...
from flashcards.settings.utils import get_logger_config
...
SECRET_KEY = os.environ.get('FLASHCARDS_SECRET_KEY', 'insecure-secret-key')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                'flashcards.apps.core.context_processors.core',
            ),
...
SESSION_COOKIE_NAME = 'flashcards_sessionid'
CSRF_COOKIE_NAME = 'flashcards_csrftoken'
LANGUAGE_COOKIE_NAME = 'flashcards_language'
