...
from flashcards.settings.local import *  # pylint: disable=wildcard-import
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DB_HOST', 'flashcards.db'),
...
SOCIAL_AUTH_EDX_OAUTH2_KEY = os.environ.get('SOCIAL_AUTH_EDX_OAUTH2_KEY', 'flashcards-sso-key')
SOCIAL_AUTH_EDX_OAUTH2_SECRET = os.environ.get('SOCIAL_AUTH_EDX_OAUTH2_SECRET', 'flashcards-sso-secret')
...
BACKEND_SERVICE_EDX_OAUTH2_KEY = os.environ.get('BACKEND_SERVICE_EDX_OAUTH2_KEY', 'flashcards-backend-service-key')
BACKEND_SERVICE_EDX_OAUTH2_SECRET = os.environ.get(
    'BACKEND_SERVICE_EDX_OAUTH2_SECRET',
    'flashcards-backend-service-secret'
)
