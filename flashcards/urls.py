...
from flashcards.apps.api import urls as api_urls
from flashcards.apps.core import views as core_views
...
urlpatterns = oauth2_urlpatterns + [
    ...
    re_path(r'^api-docs/', get_swagger_view(title='flashcards API')),
