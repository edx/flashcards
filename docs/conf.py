...
"""
flashcards documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'flashcards',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edx/flashcards",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Service for managing and displaying flashcards',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'flashcards'),
                os.path.join(root_path, 'flashcards/migrations')])
